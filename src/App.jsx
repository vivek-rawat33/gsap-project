    ...
    <>
      <div data-scroll-container>
        ...
        <div className="w-full relative min-h-screen">
          ...
          <div
            className="w-full h-screen px-4 md:px-8"
            data-scroll
            data-scroll-speed="0.5"
          >
            <nav className="w-full py-4 flex flex-col md:flex-row justify-between items-center gap-4 md:gap-0">
              <h1 className="font-semibold text-2xl">Thirtysixstudios</h1>
              <ul className="flex gap-4 md:gap-8 flex-wrap justify-center items-center">
                {["Home", "About", "Projects", "Contact"].map((link, index) => (
                  <li
                    key={index}
                    className="hover:text-yellow-400 cursor-pointer text-sm md:text-base"
                  >
                    {link}
                  </li>
                ))}
            ...
            <div className="container w-full px-4 md:px-[10%] lg:px-[20%]">
              <div className="text w-full md:w-[80%] lg:w-[50%]">
                <h3 className="text-xl md:text-2xl lg:text-3xl leading-relaxed">
                  At Thirtysixstudio, we build digital assets and immersive
                  experiences for purposeful brands.
                </h3>
                <p className="text-sm md:text-base w-full md:w-[90%] mt-5 font-light relative z-[1]">
                  We're a boutique production studio focused on design,
                  animation, and technology, constantly rethinking what digital
                  craft can do for present-day ads and campaigns.
                </p>
                <p className="mt-7 text-sm md:text-base">Scroll</p>
              </div>
            </div>
            ...
            <div className="overflow-x-hidden w-full">
              <div className="w-full text-center absolute bottom-0 left-0">
                <h1
                  ref={headingRef}
                  className="text-6xl md:text-[10rem] lg:text-[15rem] font-normal tracking-tight leading-none"
                >
                  Thirtysixstudio
                </h1>
              </div>
        ...
        <div
          className="w-full relative h-auto min-h-screen mt-20 px-4 md:px-10"
          data-scroll
          data-scroll-speed="0.5"
        >
          {showCanvas &&
          ...
          <h1 className="text-4xl md:text-6xl lg:text-8xl tracking-tighter">
            About the brand
          </h1>

          <p className="text-base md:text-xl lg:text-3xl leading-relaxed w-full md:w-[90%] lg:w-[70%] mt-6 md:mt-8 font-light">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi
            ratione voluptates earum aspernatur nesciunt hic, ipsa tenetur
            dolores, enim iusto sapiente voluptate praesentium laudantium rem!
            Eligendi aperiam error aliquam laborum.
          ...
          <div
            className="flex flex-col md:flex-row gap-6 justify-center items-center relative mt-10 pb-10"
            data-scroll
            data-scroll-speed="0.5"
          >
            {showCanvas &&
            ...
            <img
              className="w-full md:w-[70%] lg:w-[40%] rounded-3xl"
              src="https://images.pexels.com/photos/2007647/pexels-photo-2007647.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
              alt=""
            />
          </div>
          ...
          <footer
            className="w-full overflow-x-hidden p-6 md:p-10 lg:p-20"
            data-scroll
          >
            <String />
            <h1 className="text-base md:text-xl lg:text-2xl font-bold tracking-wide">
              Made by Vivek Singh Rawat
            </h1>
          </footer>
        </div>
